...
def accident_detection():
    ...
    try:
        ...
        model_path = r"C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\project files\ANPR_and_ATCC_for_Smart_Traffic_Management\Smart_traffic_management_system_with_ANPR_and_ATCC\PROJECT_ZIP\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT\models\best.pt"  # Use your YOLO model path

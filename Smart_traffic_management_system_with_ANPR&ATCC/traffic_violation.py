...
license_plate_cascade = cv2.CascadeClassifier(r"Smart_traffic_management_system_with_ANPR_and_ATCC\PROJECT_ZIP\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT\models\YOLO\haarcascade_russian_plate_number.xml")
...
def main():
    ...
    # Open the video file
    vid = cv2.VideoCapture(r'C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\project files\ANPR_and_ATCC_for_Smart_Traffic_Management\Smart_traffic_management_system_with_ANPR_and_ATCC\PROJECT_ZIP\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT\static\uploads\signal_jumping.mp4')
